...
2026-08-20 — M8G raw inventory authority corrected
...
- 2026-08-23 M8 current-teacher selected-pass gate: benchmark-only 64-source/71-coordinate authority generated on T4; all 12 native C6 samples completed without OOM or fallback, but batch-1 and batched output roots differed and the best batch-8 gain was 7.277%, so the equivalence/20% gate was not accepted.
- 2026-08-23 M8 selected-pass equivalence closure: prior logical_body_root was proven to be a selected-exemplar output-byte hash rather than a canonical logical-evidence root; ephemeral Modal body trees prevented retrospective body comparison, no production batching defect was proven, and the 7.277%% batch-8 gain remains below the 20%% gate.
- 2026-08-23 M8 sparse selected-logits: canonical gpu_torch previously projected full [batch, sequence, vocabulary] logits before gathering; official logits_to_keep union path was implemented, but the T4 harness failed to persist one raw sparse sample and per-coordinate logical roots, so adoption is blocked pending lossless evidence.
- 2026-08-23 M8 sparse truncated batched selected: added internal causally-required prefix lengths, per-source truncation before governed padding, deterministic length-aware execution ordering, and local prefix-tokenization coverage; benchmark evidence pending.
- 2026-08-23 M8 sparse truncation correction: tokenize under the original sequence policy before slicing prefixes, preventing EOS/special-token relocation from changing selected causal logits.
- 2026-08-23 M8 sparse truncated batched selected closure: CPU accounting found 3,559 avoidable suffix tokens across 64 sources; corrected smoke still exceeded governed entropy tolerance at corpus_000000662 position 6 (0.85546875 vs 0.84765625, delta 0.0078125), so no T4 timing sample was accepted and the optimization is equivalence-failed.
- 2026-08-23 M8 sparse prefix accounting closure: recorded retained-length distribution, 43.445% suffix opportunity, batch-8 padding/union accounting, and governed-smoke failure evidence.
- 2026-08-23 M8 sparse truncated batched selected independent review: blocked adoption on the governed corpus_000000662 position-6 entropy mismatch; prefix accounting/remapping were accepted as internally consistent and no timing sample was accepted.
...
- 2026-08-29 M10 final completion: completed the post-change full suite (1,230 passed, 9 skipped) and wheel build; final audit readiness still depends on the unresolved v2 production seam and 50K bound.
- 2026-08-29 M10 final-completion closure: routed v2 selected-rerun loading through the verified corpus reader and accepted absolute journal destinations only within the owning publication parent; added focused recovery coverage, with 50K bounded-memory validation and final gate receipts pending closure refresh.
- 2026-08-29 M10 final completion: closed the verified v2 reader, absolute-destination recovery boundary, destination-parent creation, and mandatory duplicate-provenance inventory; recorded the 50K bounded-memory run and preserved unrelated historical test compatibility failures for external audit.
...
- 2026-09-05: M11 workflow integration: wired the Textual wizard through canonical preflight, run, and separate package actions; fixed v2 path-field serialization, production run planning and streaming hashes for verified corpus artifacts, teacher-textbook validation dispatch, bounded JSONL feasibility, and hash-checked journal status.
- 2026-09-05: M11 compatibility characterization: extended the canonical configuration tests to prove smoke selection fields ending in “_path” remain strings and survive reload without changing the M5 authority projection.
- 2026-09-05: M11 bounded-memory correction: explicit deduplication=false now streams records without unnecessary DuckDB spill while retaining bounded counters and an empty provenance member; the 50,000-record proof completed with stable RSS and validated identity.
- 2026-09-05: M11 full-suite reconciliation: kept artifact validation builder-independent by consuming the lower-layer verified corpus reader directly, and registered all M11 source modules in the Hydra disposition inventory.
- 2026-09-05: M11 closure documentation: recorded canonical wizard/production boundaries, clean-install corpus and CPU production smoke, the 50,000-record bounded direct-stream measurement, and the explicit external-audit handoff without claiming independent acceptance.
- 2026-09-05: M11 evidence sealing: bound the machine receipt to implementation `20cbbdeb` and documentation commit `9ec7d92`; checksum publication follows in this commit without changing implementation behavior.
- 2026-09-05: M11 bounded audit correction: replaced the generic wizard surface with workflow-specific tabs and fields, added exact saved-byte checks, effective resume/overwrite preflight and native resume projection, and implemented bounded subprocess streaming with confirmed interrupt/force-stop preservation; focused regressions cover the corrected seams.
- 2026-09-05: M11 review disposition: preserved the independent auditor's initial FAIL, recorded the bounded correction and targeted recheck, refreshed the command/help/review receipts, and retained the limitation that no second review was performed.
- 2026-09-05: M11 final evidence seal: bound the closure receipt to audited implementation `07367a7` and evidence commit `9fd440d`; the next commit only refreshes the self-referential seal hash and does not change implementation or review disposition.
...
\n### 2026-09-24  M13 runtime-authority reconciliation\n\nAdded an evidence-only reconciliation distinguishing the Golden contract's\ndeclared semantic authority from runtime metadata in smoke and production\nreceipts. Preserved the frozen Golden, accepted 10K result, tolerances, and\nraw T4 evidence. The final policy-aligned 1K discriminator remains blocked by\n128 missing/128 extra coordinates, requiring an owner decision about the\nhistorical parity oracle rather than another implementation loop.\n
- 2026-09-24: M13 owner-approved versioned-reference acceptance: preserved historical Golden parity as failed and recorded M13_CURRENT_PRODUCTION_REFERENCE_V1 with distinct producer and acceptance SHAs, durable output retention, and explicit M14 prerequisite binding; no runtime or Contract behavior changed.
